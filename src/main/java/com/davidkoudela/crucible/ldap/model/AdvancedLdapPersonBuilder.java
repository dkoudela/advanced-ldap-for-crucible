...
public class AdvancedLdapPersonBuilder implements AdvancedLdapPersonSearchResultBuilder {
    ...
    public AdvancedLdapPersonBuilder(AdvancedLdapOptions advancedLdapOptions, Boolean followMembers) {
    ...
    public void handlePagedSearchResult(SearchResultEntry searchResultEntry) {
        ...
        advancedLdapPerson.setUid(searchResultEntry.getAttributeValue(this.advancedLdapOptions.getUIDAttributeKey()));
        advancedLdapPerson.setDisplayName(searchResultEntry.getAttributeValue(this.advancedLdapOptions.getDisplayNameAttributeKey()));
        advancedLdapPerson.setEmail(searchResultEntry.getAttributeValue(this.advancedLdapOptions.getEmailAttributeKey()));
        ...
        if (this.followMembers) {
            Attribute groupDns = searchResultEntry.getAttribute(this.advancedLdapOptions.getGroupAttributeKey());
            ...
            for (String groupDn : groupDns.getValues()) {
                ...
                try {
                    ...
                    AdvancedLdapGroupBuilder advancedLdapGroupBuilder = new AdvancedLdapGroupBuilder(this.advancedLdapOptions, false);
                    advancedLdapConnector.ldapPagedSearch(this.advancedLdapOptions, searchRequest, advancedLdapGroupBuilder);
